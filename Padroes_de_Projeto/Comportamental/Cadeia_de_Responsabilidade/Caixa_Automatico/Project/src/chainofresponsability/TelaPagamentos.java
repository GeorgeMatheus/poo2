...
public class TelaPagamentos extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       NotaHandler cem = new CemHandler();               
       NotaHandler cinquenta = new CinquentaHandler();
       NotaHandler vinte = new VinteHandler();
       NotaHandler dez = new DezHandler();
       NotaHandler cinco = new CincoHandler();
       NotaHandler dois = new DoisHandler();
       ...
       cem.processHandler(Integer.parseInt(valorFatura.getText()));                       
